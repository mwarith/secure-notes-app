...
| §13 Automated Testing | 306 unit/integration tests shipped per-ticket, red-green; pure-policy modules for branching logic | per-ticket | Ongoing |
