...
| §9 Error Experience | Classification layer: four classes (user_input/auth/operational/unexpected), class-derived retryability, safe normalization, internal capture, compiler-checked ten-case map; auth flows wired (crash-proof actions, classified expected paths); notes wiring pending | ENG-33, ENG-34 | Merged (PRs #32, #33); wiring ENG-35 pending |
