  ...
  return (
    <li>
      <DialogTrigger asChild>
        <button
          type="button"
          className="focus-visible:ring-ring/50 flex h-44 w-full flex-col justify-between gap-2 rounded-xl border bg-card p-4 text-left shadow-sm outline-none transition-[translate,box-shadow] hover:-translate-y-0.5 hover:shadow-md focus-visible:ring-3"
        >
